...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(Objects.isNull(loginUser), ErrorCode.PARAMS_ERROR, "尚未登录无法使用");
        // 构造入库对象
        App app = new App();
     ...
     */
    @PostMapping("/delete")
    public BaseResponse<Boolean> deleteApp(@RequestBody AppUpdateRequest deleteRequest, HttpServletRequest request) {
    ...
    public BaseResponse<Boolean> deleteAppByAdmin(@RequestBody AppUpdateRequest deleteRequest) {
        if (deleteRequest == null || deleteRequest.getId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        long id = deleteRequest.getId();
